...
const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5">
      ...
      <div className={`max-md:absolute max-md:top-git0 max-md:left-0 max-md:font-medium max-md:text-lg z-50 
        ...
        {/* XIcon used to close the mobile menu (visible on small screens when menu is open) */}
      ...
      <div className='flex items-center gap-8'>
        ...
        <button className='px-4 py-1 sm:px-7 sm:py-2 bg-cyan-500 hover:bg-cyan-400 text-white font-medium 
        rounded-full cursor-pointer transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-cyan-400/60
'>Login</button>
      </div>
